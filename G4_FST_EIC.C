...
void FSTSetup(PHG4Reco *g4Reco)
{
  ...
  const double bkwd_z[] = {25, 45, 70, 100, 130};
  double bkwd_rmin[] = {3.6, 3.6, 3.6, 4.3, 5.3};
  double bkwd_rmax[] = {25.0, 39.0, 39.0, 45.7, 59.};
...
*/  
  ...
  const double fwd_z[] = {25, 45, 70, 100, 130,160};
  double fwd_rmin[] = {3.6, 3.6, 4., 5.3, 7., 8.5};
  double fwd_rmax[] = {24.0, 39.0, 39.0, 39.0, 51.5, 63.};
